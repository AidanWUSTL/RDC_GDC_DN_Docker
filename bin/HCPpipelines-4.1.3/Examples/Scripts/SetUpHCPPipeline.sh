...
whichwb=`which wb_command`;
export CARET7DIR=`echo $(dirname $whichwb)`
...
#####export CARET7DIR=
#module load msm-v3 - commented out 6/30/2021
export MSMCONFIGDIR="${HCPPIPEDIR}/MSMConfig"
export MATLAB_COMPILER_RUNTIME=/export/matlab/MCR/R2016b/v91
#module load fsl-fix-1.067 - commented out 6/30/2021 and replaced with the FSL module

...
#        --brainsize=${BrainSize}
	...
	#kenleyj edited for baby data so there would be no resampling
	echo ""
	echo "Skipping ACPC alignment!!"
	echo ""
	echo "cp ${TXwFolder}/${TXwImage}.nii.gz ${TXwFolder}/${TXwImage}_acpc.nii.gz"
	cp ${TXwFolder}/${TXwImage}.nii.gz ${TXwFolder}/${TXwImage}_acpc.nii.gz
	echo ""
